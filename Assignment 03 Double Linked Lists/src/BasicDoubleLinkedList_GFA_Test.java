...
public class BasicDoubleLinkedList_GFA_Test {
	...
	public Huh a = new Huh("bung", "F341", 2005);
	public Huh b = new Huh("yoom", "Rokelahx", 2005);
	public Huh c = new Huh("AA", "Covie", 2005);
	public Huh d = new Huh("PO", "Omeganh", 2005);
	public Huh e = new Huh("POahxnjrmk", "Songanhem", 2005);
	public Huh f = new Huh("123412341234", "PMChotien", 2005);
	...
	public void testIteratorNoSuchElementExceptionNext() {
		...
		try {
			iteratorHuh.next();
			assertTrue("Do not throw NoSuchElementException", false);
		} catch (NoSuchElementException e) {
			assertTrue("Successfully threw NoSuchElementException", true);
		} catch (Exception e) {
			assertTrue("Threw an exception differ than NoSuchElementException", false);
		}
	...
	public void testIteratorUnsupportedOperationException() {
		...
		try {
			...
			iteratorHuh.remove();
			assertTrue("Do not throw UnsupportedOperationException", false);
		} catch (UnsupportedOperationException e) {
			assertTrue("Successfully threw UnsupportedOperationException", true);
		} catch (Exception e) {
			assertTrue("Threw an exception differ than UnsupportedOperationException", false);
		}
