...
public class BasicDoubleLinkedList<T> implements Iterable<T> {
	 ...
	 * @return data of first element if exists, if differ then null
	 */
	 ...
	 * @return data of last element if exists, if differ then null
	 */
	...
	protected class DoubIterator implements ListIterator<T> {
		...
		/**
		 * check if another element in list
		...
		/**
		 * set pointer to next one if possible
		...
		/**
		 * check if there is element before i in list
		...
		/**
		 * set pointer to previous one if possible
		 * @throw NoSuchElementException when not possible to set pointer to previous one
