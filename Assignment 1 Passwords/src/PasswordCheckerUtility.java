...
public class PasswordCheckerUtility {
	 ...
	 * 
	 * @param p
	 * @return is password valid or not
	 ...
	 * 
	 * @param p
	 * @return false means password is weak
	 ...
	 * 
	 * @param p
	 * @return passwords array that are invalid and showed their error messages
	 */
	 ...
	 * 
	 * @param p
	 * @return true means password is at least 6 characters long
	 * @throws LengthException
	 */
	 ...
	 * 
	 * @param p
	 * @return true means there is a uppercase in password
	 * @throws NoUpperAlphaException
	 */
	 ...
	 * 
	 * @param p
	 * @return true means there is a lowercase in password
	 * @throws NoLowerAlphaException
	 */
	 ...
	 * 
	 * @param p
	 * @return true means there is a digit in password
	 * @throws NoDigitException
	 */
	 ...
	 * 
	 * @param p
	 * @return true means there is a non alphanumeric character in password
	 * @throws NoSpecialCharacterException
	 */
	 ...
	 * 
	 * @param p
	 * @return true means there is no sequence of same characters longer than 2 in password
	 * @throws InvalidSequenceException
	 */
